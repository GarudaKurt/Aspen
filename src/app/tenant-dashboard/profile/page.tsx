      ...
      <div className="mt-7 grid gap-5 xl:grid-cols-[1.5fr_1fr]">
        <Card className="bg-white p-6 shadow-none">
          ...
          <dl className="mt-5 grid gap-5 sm:grid-cols-2">
            <div>
              ...
              <dd className="font-semibold">PawSpot Grooming & Boarding</dd>
            </div>
            <div>
            ...
            <div>
              ...
              <dd className="font-semibold">Cebu City</dd>
            </div>
        ...
        <Card className="bg-white p-6 text-center shadow-none">
          ...
          <h2 className="mt-4 text-xl font-semibold">
            PawSpot Grooming & Boarding
          </h2>
          <p className="text-slate-500">Cebu City · Grooming, Boarding</p>
          <p className="mt-4 text-[#c5714e]">★ 4.9 (38 reviews)</p>
        </Card>
      </div>
      <Card className="mt-5 p-6 bg-white shadow-none">
        <h2 className="text-xl font-semibold">Services & coverage</h2>
        <div className="mt-4 flex flex-wrap gap-2">
          {["Grooming", "Boarding", "Training"].map((item) => (
            <span
              key={item}
