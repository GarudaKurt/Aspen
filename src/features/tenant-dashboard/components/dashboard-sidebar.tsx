...
export function DashboardSidebar() {
  ...
  return (
    <Sidebar className="lg:relative">
      ...
      >
        <div
          className={`mb-6 flex items-center ${open ? "justify-between" : "justify-center"}`}
        >
                ...
                .map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`flex items-center rounded-lg py-2.5 text-sm font-medium transition-colors ${open ? "gap-3 px-3" : "justify-center px-2"} ${active ? "bg-[#e8f5ef] text-[#3c6355]" : "text-slate-700 hover:bg-slate-50"}`}
