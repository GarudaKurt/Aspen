    ...
    <section id="browse" className="px-6 pb-12 pt-8 sm:px-10 sm:pb-16 sm:pt-10 lg:px-[130px]">
      <div className="mx-auto max-w-[1440px]">
        ...
        <form onSubmit={submitSearch} className="mt-7 flex max-w-[660px] flex-col overflow-hidden rounded-2xl border border-[#c8c8c5] bg-white sm:h-[62px] sm:flex-row sm:items-center">
          ...
          <Button variant="ghost" type="submit" aria-label="Search" title="Search" className="mx-2 mb-2 inline-flex size-11 min-h-[44px] items-center justify-center rounded-xl bg-transparent p-0 text-[#2c2c2c] transition-colors hover:bg-[#f3f3f2] hover:text-[#3c6355] sm:my-2 sm:mb-0"><Search size={22} strokeWidth={1.8} /></Button>
        </form>
