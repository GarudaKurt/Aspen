...
export function LandingPage() {
  ...
  return (
    <main id="top" className="min-h-screen bg-white text-[#111111]">
      ...
      <DiscoverySearch query={query} city={city} onQueryChange={setQuery} onCityChange={setCity} onSearch={setSubmittedQuery} />
      <FeaturedStores />
      <ServiceBrowse />
      ...
      <section id="legacy-list-your-business" className="sr-only" aria-label="List your business">
